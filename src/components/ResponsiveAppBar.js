...
exports.ResponsiveAppBar = void 0;
...
var pages = ['My Bets', 'Odds Marketplace', 'Parlay Probability Calculator'];
...
var ResponsiveAppBar = function () {
    ...
    return (React.createElement(AppBar_1["default"], { position: 'fixed', sx: {
            width: '83%'
        } },
        React.createElement(Container_1["default"], null,
            React.createElement(Toolbar_1["default"], { disableGutters: true },
                ...
                React.createElement(Typography_1["default"], { variant: "h6", noWrap: true, component: "a", href: "#app-bar-with-responsive-menu", sx: {
                        mr: 2,
                ...
                React.createElement(Box_1["default"], { sx: { flexGrow: 1, display: { xs: 'flex', md: 'none' } } },
                    ...
                    React.createElement(Menu_1["default"], { id: "menu-appbar", anchorEl: anchorElNav, anchorOrigin: {
                            ...
                            vertical: 'top',
                            horizontal: 'left'
                        }, open: Boolean(anchorElNav), onClose: handleCloseNavMenu, sx: { display: { xs: 'block', md: 'none' } } }, pages.map(function (page) { return (React.createElement(MenuItem_1["default"], { key: page, onClick: handleCloseNavMenu },
                        React.createElement(Typography_1["default"], { sx: { textAlign: 'center' } }, page))); }))),
                React.createElement(Adb_1["default"], { sx: { display: { xs: 'flex', md: 'none' }, mr: 1 } }),
                React.createElement(Typography_1["default"], { variant: "h5", noWrap: true, component: "a", href: "#app-bar-with-responsive-menu", sx: {
                        mr: 2,
                ...
                React.createElement(Box_1["default"], { sx: { flexGrow: 0 }, display: 'flex', flexDirection: 'row' },
                    React.createElement(Box_1["default"], { sx: {
                            ...
                            borderRadius: 2,
                            // bgcolor: '#007FFF',
                            bgcolor: Theme_1.Colors.heavyPurple,
                            borderColor: '#000000',
                            border: '1px solid',
                            paddingX: '0px',
                            marginRight: 1
                        }, onClick: handleLoginClick },
                        React.createElement(Typography_1["default"], { variant: 'button' }, "Log In")),
                    React.createElement(Box_1["default"], { sx: {
                            width: 90,
                            height: 40,
                            borderRadius: 2,
                        ...
                        React.createElement(Typography_1["default"], { variant: 'button' }, "Sign Up")),
                    ...
                    React.createElement(Menu_1["default"], { sx: { mt: '45px' }, id: "menu-appbar", anchorEl: anchorElUser, anchorOrigin: {
                        ...
                        React.createElement(Typography_1["default"], { sx: { textAlign: 'center' } }, setting))); })))))));
};
exports.ResponsiveAppBar = ResponsiveAppBar;
